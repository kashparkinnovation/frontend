...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([prodData, schoolData]) => {
        ...
        const first = prodData.inventory.find((i) => i.quantity > 0);
        if (first) {
  ...
  const allImages = [
    ...product.images.map((img) =>
      img.image.startsWith("http") ? img.image : `${API_BASE}${img.image}`,
    ),
  ];
  if (
    product.primary_image_url &&
    !allImages.includes(product.primary_image_url)
  ) {
                ...
                {allImages.map((img, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: 100,
                      borderRadius: "12px",
                      border: `2px solid ${activeImg === i ? "#4f46e5" : "transparent"}`,
                      overflow: "hidden",
                      padding: 0,
                      cursor: "pointer",
                      background: "#f8fafc",
          ...
          <div style={{ position: "sticky", top: "7rem" }}>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Orders are typically dispatched within 24-48 hours. Delivery
                    to your school or home address.
                  </p>
                </div>
                <div>
                  <h4
                  ...
                  >
                    7-day hassle-free returns for size exchanges. Items must be
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: "12px",
                          border: `2px solid ${selectedSize === size ? "#0f172a" : "#e2e8f0"}`,
                          background:
                            selectedSize === size
                              ? "#0f172a"
                              : available
                  ...
                  {colorsForSize.map((color) => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "12px",
                        border: `2px solid ${selectedColor === color ? "#0f172a" : "#e2e8f0"}`,
                        background:
                          selectedColor === color ? "#0f172a" : "white",
            ...
            <div style={{ marginBottom: "2.5rem" }}>
              ...
              >
                ...
                <button
                  onClick={() =>
                    setQty(Math.min(selectedVariant?.quantity ?? 10, qty + 1))
                  }
                  style={{
                    width: 44,
                    height: 44,
            ...
            {!isAuthenticated ? (
              ...
              >
                ...
                >
                  Create a parent profile to purchase official uniforms for your
                  child.
                </p>
              ...
              >
                ...
                >
                  ⏳ Your active student is not verified for this school yet.
                </p>
                <Link
                  href="/store/students"
                  style={{
                ...
                style={{
                  ...
                  background: added
                    ...
                    : inStock && selectedSize
                      ? "#4f46e5"
                      : "#e2e8f0",
                  color: inStock && selectedSize ? "white" : "#94a3b8",
                  fontWeight: 800,
                  fontSize: "1.125rem",
                  cursor: inStock && selectedSize ? "pointer" : "not-allowed",
                  transition: "all 0.2s",
                  marginBottom: "1rem",
                  display: "flex",
                  alignItems: "center",
            ...
            {selectedVariant && (
              ...
              >
                ...
                />
                {selectedVariant.quantity} unit
                {selectedVariant.quantity !== 1 ? "s" : ""} available
              </div>
            )}
          </div>
        </div>
