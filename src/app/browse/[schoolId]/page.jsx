  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "1rem" }}>
        ...
        <div
          className="mat-shimmer"
          style={{ height: 20, borderRadius: "6px", marginBottom: "0.75rem" }}
        />
        <div
          className="mat-shimmer"
          style={{ height: 16, borderRadius: "6px", width: "40%" }}
        />
      </div>
    </div>
  );
...
export default function SchoolCataloguePage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([s, p]) => {
        ...
        const prices = prods.map((pr) => parseFloat(pr.base_price));
        if (prices.length)
          setMaxPrice(Math.ceil(Math.max(...prices) / 100) * 100 + 200);
      })
      .catch(console.error)
  ...
  const imgUrl = useCallback((p, secondary = false) => {
    const imgs = p.images;
    if (secondary && imgs.length > 1) {
      const nonPrimary = imgs.find((i) => !i.is_primary) || imgs[1];
      return nonPrimary?.image
        ? nonPrimary.image.startsWith("http")
          ? nonPrimary.image
          : `${API_BASE}${nonPrimary.image}`
        : null;
    }
    if (p.primary_image_url) return p.primary_image_url;
    const primary = imgs.find((i) => i.is_primary) || imgs[0];
    return primary?.image
      ? primary.image.startsWith("http")
        ? primary.image
        : `${API_BASE}${primary.image}`
      : null;
  }, []);
  ...
  const filteredProducts = products
    .filter((p) => {
      ...
      const matchSize =
        ...
        p.inventory.some(
          (i) => selectedSizes.includes(i.size) && i.quantity > 0,
        );
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                'url("https://images.unsplash.com/photo-1594938298596-70f56fb3cecb?auto=format&fit=crop&w=2000&q=80")',
            ...
            >
              <div
                style={{
                  ...
                  padding: logoUrl(school.logo) ? 0 : "1rem",
                }}
              >
                {logoUrl(school.logo) ? (
                  <img
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  <span
                    className="mat-badge mat-badge-green"
                    style={{
                  ...
                  {products.length > 0 && (
                    <span
                      className="mat-badge mat-badge-blue"
                      style={{
      ...
      {!isAuthenticated && (
        ...
        >
          ...
          >
            ...
            >
              🔒 <strong>Sign in to order.</strong> Browse freely — add to cart
              after logging in.
            </p>
      ...
      {needsVerification && activeStudent && (
        ...
        >
          ...
          >
            ...
            >
              ⏳ <strong>{activeStudent.student_name}</strong> is not yet
              verified for this school.
            </p>
            <Link
              href={`/store/students/${activeStudent.id}`}
              style={{
                background: "#ea580c",
                color: "white",
                padding: "0.4rem 0.875rem",
        ...
        <aside className="mat-filter-sidebar" style={{ display: "flex" }}>
          ...
          <div
            style={{
              ...
              borderBottom: "1px solid var(--mat-border-light)",
              display: "flex",
              justifyContent: "space-between",
              alignItems: "center",
            }}
            ...
            {categories.map((cat) => (
              <label key={cat} className="mat-filter-option">
                <input
                  ...
                  onChange={() =>
                    setSelectedCats(toggleFilter(selectedCats, cat))
                  }
                />
                <span>
                  {CAT_ICON[cat] || "👕"}{" "}
            ...
            {GENDERS.map((g) => (
              <label key={g.value} className="mat-filter-option">
                <input
                  ...
                  onChange={() =>
                    setSelectedGenders(toggleFilter(selectedGenders, g.value))
                  }
                />
                {g.label}
              </label>
          ...
          <div className="mat-filter-section">
            ...
            >
              <span>₹0</span>
              <strong style={{ color: "var(--mat-primary)" }}>
          ...
          <div className="mat-filter-section">
            ...
            <div style={{ display: "flex", gap: "0.4rem", flexWrap: "wrap" }}>
              {SIZES.filter((s) =>
                products.some((p) =>
                  p.inventory.some((i) => i.size === s && i.quantity > 0),
                ),
              ).map((size) => (
                <button
                  key={size}
                  onClick={() =>
                    setSelectedSizes(toggleFilter(selectedSizes, size))
                  }
                  style={{
                    padding: "0.3rem 0.625rem",
                    borderRadius: "6px",
                    border: `1.5px solid ${selectedSizes.includes(size) ? "var(--mat-primary)" : "var(--mat-border)"}`,
                    background: selectedSizes.includes(size)
                      ? "var(--mat-primary-light)"
                      : "white",
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="Search uniforms in this school…"
                style={{
                  border: "none",
                  outline: "none",
          ...
          {loading ? (
            ...
            >
              ...
              <h3 style={{ margin: "0 0 0.5rem", fontWeight: 800 }}>
                No uniforms found
              </h3>
              <p style={{ color: "var(--mat-text-2)", margin: "0 0 1.5rem" }}>
            ...
            >
              {filteredProducts.map((product, idx) => {
                ...
                const minPrice = product.inventory.reduce(
                ...
                return (
                  <Link
                    key={product.id}
                    href={`/browse/${schoolId}/${product.id}`}
                    style={{
                      textDecoration: "none",
                      color: "inherit",
                      display: "block",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {primaryImg ? (
                          <img
                            ...
                            style={{
                              ...
                              inset: 0,
                              transition:
                                "opacity 0.4s, transform 0.6s var(--mat-ease-soft)",
                              opacity: isHovered && secondaryImg ? 0 : 1,
                          ...
                          <div
                            style={{
                              ...
                              justifyContent: "center",
                              background:
                                "radial-gradient(circle, #e2e8f0 0%, #cbd5e1 100%)",
                            }}
                          >
                            <img
                        ...
                        {secondaryImg && isHovered && (
                          <img
                            ...
                            style={{
                              ...
                              position: "absolute",
                              inset: 0,
                              animation: "mat-fade-in 0.3s ease",
                            }}
                          />
                        )}
                        {/* Badges */}
                        ...
                        >
                          {isBestseller && (
                            <span className="mat-badge mat-badge-amber">
                              ⭐ Bestseller
                            </span>
                          )}
                          {isLowStock && (
                      ...
                      <div style={{ padding: "0.875rem" }}>
                        ...
                        {availSizes.length > 0 && (
                          ...
                          >
                            ...
                            {product.inventory.filter((i) => i.quantity > 0)
                              .length > 5 && (
                              <span
                                style={{
                                  fontSize: "0.65rem",
