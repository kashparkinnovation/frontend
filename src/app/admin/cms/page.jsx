...
export default function CMSPagesAdmin() {
  ...
  const openEdit = (page) => {
    setFormData({
      ...
      custom_body_end: page.custom_body_end || "",
    });
    setSelected(page);
    setIsCreating(false);
  };
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          >
            Manage your dynamic static pages like Privacy Policy and Terms of
            Service.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p className="empty-state-desc">
              Create pages to display them dynamically on the storefront.
            </p>
          </div>
        ) : (
                    ...
                    <td>
                      <span
                        style={{
                          ...
                          color: p.is_published ? "#166534" : "#475569",
                        }}
                      >
      ...
      <Drawer
        ...
        title={isCreating ? "New CMS Page" : "Edit CMS Page"}
      ...
      >
        ...
        >
          ...
          >
            <label style={{ fontSize: "0.875rem", fontWeight: 600 }}>
              Header Code (Optional)
            </label>
            <p style={{ fontSize: "0.75rem", color: "#94a3b8", margin: 0 }}>
              Injected into the &lt;head&gt; of this page. Useful for custom CSS
              or meta tags.
            </p>
            <textarea
              className="input"
              ...
              onChange={(e) =>
                setFormData({ ...formData, custom_head: e.target.value })
              }
          ...
          >
            ...
            <p style={{ fontSize: "0.75rem", color: "#94a3b8", margin: 0 }}>
              Injected just before &lt;/body&gt;. Useful for custom JS trackers
              or scripts.
            </p>
            <textarea
              className="input"
              ...
              onChange={(e) =>
                setFormData({ ...formData, custom_body_end: e.target.value })
              }
                  ...
                  if (confirm("Are you sure you want to delete this page?")) {
                    try {
                      await apiClient.delete(
                        `/admin/blog/pages/${selected.slug}/`,
                      );
