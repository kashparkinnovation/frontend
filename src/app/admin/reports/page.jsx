...
export default function AdminReportsPage() {
  ...
  const exportCSV = () => {
    ...
    const rows = [
      ...
      ...Object.entries(stats.orders.by_status).map(([s, c]) => [
        `Orders (${s})`,
        c,
      ]),
    ];
  ...
  const totalOrders = Object.values(stats.orders.by_status).reduce(
    (a, b) => a + b,
    0,
  );
    ...
    <div style={{ padding: "2rem" }}>
        ...
        {[
          {
            ...
            sub: `${stats.schools.approved} approved · ${stats.schools.pending} pending`,
            color: "#4f46e5",
          },
          {
            label: "Active Vendors",
            value: stats.vendors.approved,
            sub: `${stats.vendors.pending} pending approval`,
            color: "#8b5cf6",
          },
          {
            label: "Verified Students",
            value: stats.students.verified,
            sub: `of ${stats.students.total} total profiles`,
            color: "#06b6d4",
          },
          {
            label: "Total Users",
          ...
          },
          {
            ...
            sub: `${fmt(stats.revenue.total)} total revenue`,
            color: "#f59e0b",
          },
          {
                    ...
                    >
                      <div
                        style={{
                          width: `${pct}%`,
                          height: "100%",
                          background: STATUS_COLORS[s] || "#4f46e5",
                          borderRadius: "9999px",
      ...
      >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <strong style={{ color: "#10b981" }}>
                {stats.schools.approved}
              </strong>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#64748b" }}>Pending</span>
              <strong style={{ color: "#f59e0b" }}>
                {stats.schools.pending}
              </strong>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#64748b" }}>Rejected</span>
              <strong style={{ color: "#ef4444" }}>
                {stats.schools.rejected}
              </strong>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#64748b" }}>Total Profiles</span>
              <strong>{stats.students.total}</strong>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#64748b" }}>Verified</span>
              <strong style={{ color: "#10b981" }}>
                {stats.students.verified}
              </strong>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#64748b" }}>Unverified</span>
              <strong style={{ color: "#f59e0b" }}>
                {stats.students.total - stats.students.verified}
              </strong>
            </div>
          </div>
        </div>
