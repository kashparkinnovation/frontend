...
export default function ProfilePage() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.875rem', fontWeight: 800, color: '#0f172a', marginBottom: '2rem' }}>Account Settings</h1>
      ...
      <div style={sectionStyle}>
        ...
        <form onSubmit={handlePersonalSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
          <div>
