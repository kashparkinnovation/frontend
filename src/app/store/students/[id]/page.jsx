...
export default function StudentDetailPage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const { data } = await apiClient.patch(`/students/${id}/`, {
  ...
  const handleVerificationRequest = async (e) => {
    ...
    try {
      ...
      await apiClient.post("/students/verify-request/", fd, {
  ...
  if (!student)
    return (
      <div style={{ textAlign: "center", padding: "3rem" }}>
        Student not found. <Link href="/store/students">← Back</Link>
      </div>
    );
    ...
    <div style={{ maxWidth: 640, margin: "0 auto" }}>
      ...
      >
        <div
          style={{
            ...
            height: 60,
            borderRadius: "50%",
            background: student.is_verified ? "#d1fae5" : "#fef3c7",
            display: "flex",
            alignItems: "center",
            ...
            fontSize: "1.5rem",
            flexShrink: 0,
            color: student.is_verified ? "#065f46" : "#92400e",
          }}
        >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: "0.875rem", color: "#64748b" }}>
            {student.class_name} {student.section} · {student.school_name}
          </div>
          {student.roll_number && (
      ...
      {tab === "details" && (
        ...
        >
          ...
          >
            {[
              { label: "Full Name", field: "student_name", required: true },
              { label: "Class / Grade", field: "class_name", required: true },
            ...
            {student.verified_at && (
              ...
              >
                ...
                >
                  {new Date(student.verified_at).toLocaleDateString("en-IN")}
                </span>
              </div>
            )}
          </div>
      ...
      {tab === "verification" && (
        ...
        >
          ...
          <div
            style={{
              background: student.is_verified ? "#d1fae5" : "#fef3c7",
              border: `1px solid ${student.is_verified ? "#6ee7b7" : "#fcd34d"}`,
              borderRadius: "12px",
              padding: "1.25rem",
            }}
          >
            ...
            >
              {student.is_verified
                ? "✅ Verified by School"
                : student.latest_verification_request?.status === "rejected"
            ...
            <p
              style={{
                margin: 0,
                fontSize: "0.875rem",
                color: student.is_verified ? "#047857" : "#b45309",
              }}
            >
              {student.is_verified
              ...
              >
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontWeight: 600, fontSize: "0.875rem" }}>
                        {idCard ? idCard.name : "Upload ID card photo"}
                      </div>
                    ...
                    <input
                      ...
                      required={
                        student.latest_verification_request?.status ===
                        "rejected"
                      }
                    />
                  </label>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize: "0.9375rem",
                    cursor: submittingVerify ? "not-allowed" : "pointer",
                    opacity: submittingVerify ? 0.7 : 1,
                    fontFamily: "inherit",
                  }}
                >
                  {submittingVerify
          ...
          {student.is_verified && (
            <Link
              href={`/store/shop/${student.school}`}
              style={{
                display: "block",
                textAlign: "center",
                background: "#4f46e5",
