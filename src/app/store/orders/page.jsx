    ...
    <div>
      ...
      >
        <div>
          ...
          <p style={{ color: "#64748b", margin: 0, fontSize: "0.9rem" }}>
            Track all uniform orders across your students.
          </p>
        </div>
      </div>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              background: statusFilter === key ? "#4f46e5" : "#f8fafc",
              color: statusFilter === key ? "white" : "#64748b",
              border: "1px solid",
              borderColor: statusFilter === key ? "#4f46e5" : "#e2e8f0",
              borderRadius: "8px",
              cursor: "pointer",
              fontWeight: 500,
              fontSize: "0.8125rem",
      ...
      {loading ? (
        ...
        >
          ...
          >
            Get started by shopping your school&apos;s uniform catalogue.
          </p>
          <Link
            href="/store"
            style={{
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.boxShadow = "0 4px 14px rgb(79 70 229/0.08)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget;
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: "0.8125rem", color: "#64748b" }}>
                    {order.student_name} · {order.school_name}
                  </div>
                  <div
                    style={{
                      fontSize: "0.75rem",
      ...
      >
        {selected && !returnModalOpen && (
          <>
            ...
            <DrawerRow
              label="Distribution"
              value={<StatusBadge status={selected.distribution_status} />}
            />
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    link.setAttribute(
                      "download",
                      `Invoice_${selected.order_number}.pdf`,
                    );
            ...
            {selected.status === "distributed" && (
              <div style={{ marginTop: "2rem", textAlign: "center" }}>
                ...
                >
                  Need a different size or received a defective item?
                </p>
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      setOrders((prev) =>
                        prev.map((o) =>
                          o.id === selected.id
                            ? { ...o, status: "cancelled", can_cancel: false }
                            : o,
                        ),
                      );
                      setSelected({
            ...
            <div style={{ display: "flex", gap: "1rem" }}>
              <label
                style={{
                  ...
                  alignItems: "center",
                  gap: "0.5rem",
                  border: `1.5px solid ${returnType === "return" ? "#4f46e5" : "#e2e8f0"}`,
                  background: returnType === "return" ? "#eef2ff" : "white",
                  padding: "1rem",
                  borderRadius: "10px",
                  cursor: "pointer",
                }}
              ...
              <label
                style={{
                  ...
                  alignItems: "center",
                  gap: "0.5rem",
                  border: `1.5px solid ${returnType === "exchange" ? "#4f46e5" : "#e2e8f0"}`,
                  background: returnType === "exchange" ? "#eef2ff" : "white",
                  padding: "1rem",
                  borderRadius: "10px",
                  cursor: "pointer",
                }}
