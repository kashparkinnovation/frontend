  ...
  return (
    <div>
      ...
      {ledger && (
        ...
        >
          ...
          >
            ...
            >
              From {ledger.pending?.orders || 0} recent orders
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div
              style={{ fontSize: "1.5rem", fontWeight: 800, color: "#4f46e5" }}
            >
              {fmt(ledger.settled?.payout || 0)}
            </div>
            <div
              style={{
                fontSize: "0.75rem",
                ...
                {orders.map((o) => (
                  <tr key={o.id} onClick={() => setSelected(o)}>
                    ...
                    <td>
                      ...
                      >
                        Earned: ₹{o.vendor_payout_amount || o.total_amount}
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <span
                        style={{
                          ...
                          fontWeight: 600,
                          background:
                            o.payout_status === "settled"
                              ? "#e0e7ff"
                              : o.payout_status === "cleared"
                                ? "#dcfce7"
                                : "#fef3c7",
                          color:
                            o.payout_status === "settled"
      ...
      <Drawer
        ...
        title={`Invoice — ${selected?.order_number ?? ""}`}
            ...
            {selected.items && selected.items.length > 0 && (
              <>
                ...
                >
                  <span>Total</span>
                  <span>
                    ₹{parseFloat(selected.total_amount).toLocaleString("en-IN")}
                  </span>
                </div>
              </>
            )}
