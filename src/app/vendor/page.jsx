    ...
    <div>
      ...
      <div className="stats-grid">
        <StatCard
          ...
          sub={
            data?.schools.pending
              ? `${data.schools.pending} pending`
              : undefined
          }
        />
        ...
        <StatCard
          ...
          sub={
            data?.orders.processing
              ? `${data.orders.processing} processing`
              : undefined
          }
        />
        ...
        <StatCard
          icon="💰"
          value={data ? fmt(data.revenue.this_month) : "₹—"}
        ...
        <StatCard
          ...
          sub={
            data?.products.out_of_stock
              ? `${data.products.out_of_stock} out of stock`
              : undefined
          }
        />
      </div>
      ...
      <div className="card">
        ...
        >
          ...
          <Link href="/vendor/orders" className="btn btn-ghost btn-sm">
            View all →
          </Link>
        </div>
        ...
        {!data?.recent_orders?.length ? (
          <div className="empty-state">
            ...
            <p className="empty-state-desc">
              Orders from students will appear here
            </p>
          </div>
        ) : (
