...
export default function SchoolReturnsPage() {
    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.75rem' }}>
        <div>
          ...
          <p style={{ color: '#64748b', margin: 0, fontSize: '0.9rem' }}>Track return requests raised by the school.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div style={{ background: 'white', border: '1px solid #e2e8f0', borderRadius: '14px', padding: '4rem', textAlign: 'center' }}>
          ...
          <Link href="/school/orders" style={{ display: 'inline-block', background: '#4f46e5', color: 'white', fontWeight: 700, padding: '0.75rem 1.75rem', borderRadius: '10px', textDecoration: 'none' }}>View Orders</Link>
        </div>
      ) : (
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '0.8125rem', color: '#64748b' }}>
                      Order: <Link href="/school/orders" style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: 600 }}>{req.order_number}</Link>
                    </div>
                  </div>
