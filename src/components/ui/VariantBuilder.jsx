  ...
  return (
    <div>
      ...
      >
        ...
        {[
          {
            label: "Clothing (XS–XXL)",
            sizes: ["XS", "S", "M", "L", "XL", "XXL"],
          },
          {
            label: "Trousers (26–38)",
          ...
          <tbody>
                ...
                <tr key={idx}>
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) =>
                        updateRow(idx, "price_override", e.target.value)
                      }
                    />
                  </td>
                  <td>
            ...
            {activeVariants.length === 0 && (
              <tr>
                ...
                >
                  No variants yet — click &quot;Add Row&quot; or use quick-add
                  above
                </td>
              </tr>
            )}
