...
export default function EmailOTP({
  ...
  const completeSignIn = async (targetEmail) => {
    ...
    if (!isSignInWithEmailLink(auth, href)) {
      setError(
        "No valid sign-in link found. Please open the link directly from your email on this device.",
      );
      return;
    }
    ...
    if (savedEmail) {
      ...
      (async () => {
        ...
        try {
          ...
          setError(
            err.message ||
              'Auto-verification failed. Please click "Verify" manually.',
          );
        } finally {
          setVerifying(false);
        }
  ...
  return (
    <div>
      ...
      ) : /* ── Phase 2: Waiting / manual verify ── */ needManual ? (
        <form
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "0.875rem", color: "#374151" }}>
              ...
              <strong>on this device</strong> and click the link — you&apos;ll
